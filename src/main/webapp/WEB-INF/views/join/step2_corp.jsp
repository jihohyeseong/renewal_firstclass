    ...
    <div class="page-wrapper">
        <div class="signup-container">
                ...
                <div class="terms-container">
                    ...
                    <div class="terms-group">
                        <div class="terms-header">
                            ...
                            <label for="termsService">육아휴직 관리 서비스 이용약관 <span class="required">(필수)</span></label>
                        </div>
                        <div class="term-content">
                            제1조 (목적) 이 약관은 기업회원이 제공하는 육아휴직 신청 및 관리 서비스를 이용함에 있어 회사와 기업회원의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.<br><br>
                            제2조 (정의) '서비스'란 회사가 기업회원에게 온라인으로 제공하는 육아휴직 신청, 결재, 관리 시스템 등을 의미합니다. '기업회원'이란 회사에 사업자 정보를 제공하여 회원등록을 한 기업으로서, 회사의 정보를 지속적으로 제공받으며, 회사가 제공하는 서비스를 계속적으로 이용할 수 있는 자를 말합니다.<br><br>
                            제3조 (약관의 명시와 개정) 회사는 이 약관의 내용을 기업회원이 쉽게 알 수 있도록 서비스 초기 화면에 게시합니다. 회사는 관련 법을 위배하지 않는 범위에서 이 약관을 개정할 수 있습니다.
                        </div>
                    </div>
                    ...
                    <div class="terms-group">
                        ...
                        <div class="term-content">
                            제1조 (목적) 본 약관은 기업회원이 제공하는 육아휴직 관련 서비스의 마케팅 정보를 수신하는 데 동의하는 경우, 정보의 종류와 수신 방법에 대해 규정하는 것을 목적으로 합니다.<br><br>
                            제2조 (정보의 종류) 회사는 이메일, SMS 등을 통해 기업 대상 신규 서비스 안내, HR 관련 세미나 정보, 제휴사 혜택 등 유용한 정보를 발송할 수 있습니다. 수신을 원치 않으실 경우 언제든지 '기업정보'에서 수신 거부로 변경할 수 있습니다.<br><br>
                            제3조 (동의 철회) 기업회원은 언제든지 마케팅 정보 수신 동의를 철회할 수 있으며, 동의를 철회하더라도 기본 서비스 이용에는 아무런 제한이 없습니다.
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="action-buttons">
                ...
                <button type="button" class="btn btn-primary btn-next" onclick="location.href='${pageContext.request.contextPath}/join/corp/3'" disabled>다음</button>
            </div>
        </div>
    </div>
